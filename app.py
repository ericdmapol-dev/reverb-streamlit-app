...
st.title("Reverb Full Clone Manager with Images")
...
def create_clone(data):
    try:
        ...
        payload = {
            ...
            "condition": {"uuid": data["condition"]["uuid"]},
